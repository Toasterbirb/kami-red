...
internal object CombatSetting : Module(
    ...
    public val passive = setting("Passive Mobs", false, { page.value == Page.TARGETING && mobs.value })
    public val neutral = setting("Neutral Mobs", false, { page.value == Page.TARGETING && mobs.value })
    public val hostile = setting("Hostile Mobs", false, { page.value == Page.TARGETING && mobs.value })
